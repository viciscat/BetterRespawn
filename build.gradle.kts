...
dependencies {
    ...
    modImplementation("curse.maven:potion_core_19-242872:2905184-sources-2905187")
    modImplementation("curse.maven:wizardry-265642:5354477")
    modImplementation(files("libs/SRParasites-1.12.2v1.9.21.jar"))
